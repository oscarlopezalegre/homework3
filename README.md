...
Homework 3 is a Ruby on Rails blog application that allows users to create and buy tickets to cool events. 

Submitted by: Oscar Lopez Alegre

Time spent: 12 hours

URL: http://agile-waters-7946.herokuapp.com/
...
We didn't studied nested forms and having diferent forms to create an event doesn't seem like good usability. I would be happy if tools that we will need to complete the tasks are given in advance.

In the other hand the work of the teachers providing solutions was very valuable
